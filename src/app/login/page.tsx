...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex overflow-hidden">
      {/* Left side with form - swapped from right */}
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex justify-end mt-1">
                <Link href="/forgot-password" className="text-sm text-[#FCB045] hover:underline">
                  Forgot Password?
                </Link>
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <Link href="/signup" className="font-medium text-[#FCB045] hover:underline">
              Sign up
            </Link>
          </p>
      ...
      {/* Right side with image - swapped from left */}
      <div className="hidden md:block md:w-1/2 bg-[#FCB045] absolute top-0 bottom-0 right-0">
